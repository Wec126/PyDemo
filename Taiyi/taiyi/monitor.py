...
from Taiyi.quantity import QuantitySelector
    ...
    def _config_parser(self):
        ...
        for module_name, quantities in self.configer.items():
            try:
                ...
                parse_quantity[module_name] = [QuantitySelector.select(quantity)(module, linear()) for quantity in
                                               quantities]
                ...
                for name, module in self.model.named_modules():
                    if self._is_module(module_name, module) and name not in parse_module.keys():
                        ...
                        parse_quantity[name] = [QuantitySelector.select(quantity)(module, linear()) for quantity in
                                                quantities]
